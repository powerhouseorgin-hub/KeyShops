...
const HEADER_PADDING = '15px 14px';
    ...
    <div>
      ...
      <div style="padding:${SECTION_GAP}px 24px 16px;">
        ...
        <div style="border:1.5px solid ${BORDER}; border-radius:8px; overflow:hidden; background:#fff; margin-bottom:${SECTION_GAP}px;">
          ...
          <div style="padding:18px 20px 22px; display:flex; align-items:flex-start; justify-content:space-between; flex-wrap:wrap; gap:16px; background:#FAFAFA;">
            <div style="min-width:140px;">
              <div style="font-size:10px; color:#666; font-weight:700; text-transform:uppercase; letter-spacing:.05em;">Bill ID / Number</div>
              <div style="font-size:14px; font-weight:800; color:${MAROON_DARK}; margin-top:8px; line-height:1.4; word-break:break-word;">${esc(naVal(billId))}</div>
            </div>
            <div style="text-align:right; min-width:140px;">
              ...
              <div style="font-size:20px; font-weight:900; color:${MAROON}; margin-top:8px; line-height:1.3; word-break:break-word;">${esc(billAmountFormatted)}</div>
            </div>
          </div>
        </div>

...
const LANGUAGES = {
  en: {
    ...
    suspendShopBtn: 'Suspend',
    accountStatusLabel: 'Account Status',
    reactivateShopBtn: 'Reactivate',
    confirmSuspendShopMsg: 'Suspend "{name}"? They will be immediately blocked from logging in.',
    ...
    contactMessagesSubtitle: 'Messages submitted through the public website’s Contact Us form.',
    contactMessagesEmpty: 'No messages yet.',
    failedLoadContactMessagesMsg: 'Failed to load contact messages.',
    ...
    offersLabel: 'Offers',
    activeOffersBannersDesc: 'Active offers, banners & promotions',
    ...
    trialPeriodDaysLabel: 'Trial Period (Days)',
    trialPeriodDaysPlaceholderEg: 'e.g. 14',
    trialPeriodDaysHint: 'Number of free days a new shop gets before payment is required on the registration wizard. Set to 0 to turn off free trials.',
    ...
    startFreeTrialBtnTemplate: 'Start {days}-Day Free Trial',
    freeTrialNoPaymentDesc: 'No payment required now - upgrade anytime from Shop Settings.',
    startingTrialEllipsis: 'Starting your trial...',
    orDividerLabel: 'or',
  ...
  hi: {
    ...
    suspendShopBtn: 'निलंबित करें',
    accountStatusLabel: 'खाता स्थिति',
    reactivateShopBtn: 'पुनः सक्रिय करें',
    confirmSuspendShopMsg: '"{name}" को निलंबित करें? उन्हें तुरंत लॉगिन करने से रोक दिया जाएगा।',
    ...
    contactMessagesTitle: 'संपर्क संदेश',
    contactMessagesSubtitle: 'सार्वजनिक वेबसाइट के संपर्क फ़ॉर्म से भेजे गए संदेश।',
    contactMessagesEmpty: 'अभी तक कोई संदेश नहीं।',
    failedLoadContactMessagesMsg: 'संपर्क संदेश लोड करने में विफल।',
    markAsReadBtn: 'पढ़ा हुआ चिह्नित करें',
    newBadge: 'नया',
    ...
    subscriptionValidUntilLabel: 'सदस्यता वैधता तिथि',
    ...
    offersLabel: 'ऑफर',
    activeOffersBannersDesc: 'सक्रिय ऑफर, बैनर और प्रचार',
    ...
    startFreeTrialBtnTemplate: '{days}-दिन का निःशुल्क ट्रायल शुरू करें',
    freeTrialNoPaymentDesc: 'अभी कोई भुगतान आवश्यक नहीं है - आप किसी भी समय शॉप सेटिंग्स से अपग्रेड कर सकते हैं।',
    startingTrialEllipsis: 'आपका ट्रायल शुरू किया जा रहा है...',
    orDividerLabel: 'या',
  ...
  ta: {
    ...
    suspendShopBtn: 'இடைநிறுத்து',
    accountStatusLabel: 'கணக்கு நிலை',
    reactivateShopBtn: 'மீண்டும் செயல்படுத்து',
    confirmSuspendShopMsg: '"{name}" ஐ இடைநிறுத்தவா? அவர்கள் உடனடியாக உள்நுழைவதிலிருந்து தடுக்கப்படுவார்கள்.',
    ...
    contactMessagesTitle: 'தொடர்பு செய்திகள்',
    contactMessagesSubtitle: 'பொது வலைத்தளத்தின் தொடர்பு படிவம் மூலம் அனுப்பப்பட்ட செய்திகள்.',
    contactMessagesEmpty: 'இதுவரை செய்திகள் இல்லை.',
    failedLoadContactMessagesMsg: 'தொடர்பு செய்திகளை ஏற்ற முடியவில்லை.',
    markAsReadBtn: 'படித்ததாக குறி',
    newBadge: 'புதியது',
    ...
    subscriptionValidUntilLabel: 'சந்தா செல்லுபடியாகும் தேதி',
    ...
    activeOffersBannersDesc: 'செயலில் உள்ள சலுகைகள், பேனர்கள் & விளம்பரங்கள்',
    ...
    startFreeTrialBtnTemplate: '{days} நாள் இலவச சோதனையைத் தொடங்குங்கள்',
    freeTrialNoPaymentDesc: 'இப்போது பணம் செலுத்த வேண்டியதில்லை - எப்போது வேண்டுமானாலும் ஷாப் அமைப்புகளில் இருந்து மேம்படுத்தலாம்.',
    startingTrialEllipsis: 'உங்கள் சோதனை தொடங்கப்படுகிறது...',
    orDividerLabel: 'அல்லது',
  ...
  te: {
    ...
    suspendShopBtn: 'సస్పెండ్ చేయండి',
    accountStatusLabel: 'ఖాతా స్థితి',
    reactivateShopBtn: 'పునఃసక్రియం చేయండి',
    confirmSuspendShopMsg: '"{name}" ను సస్పెండ్ చేయాలా? వారు వెంటనే లాగిన్ చేయకుండా నిరోధించబడతారు.',
    ...
    contactMessagesTitle: 'సంప్రదింపు సందేశాలు',
    contactMessagesSubtitle: 'పబ్లిక్ వెబ్‌సైట్ యొక్క సంప్రదింపు ఫారమ్ ద్వారా పంపిన సందేశాలు.',
    contactMessagesEmpty: 'ఇంకా సందేశాలు లేవు.',
    failedLoadContactMessagesMsg: 'సంప్రదింపు సందేశాలను లోడ్ చేయడంలో విఫలమైంది.',
    markAsReadBtn: 'చదివినట్లు గుర్తించండి',
    newBadge: 'కొత్తది',
    ...
    subscriptionValidUntilLabel: 'సబ్‌స్క్రిప్షన్ చెల్లుబాటు తేదీ',
    ...
    offersLabel: 'ఆఫర్‌లు',
    activeOffersBannersDesc: 'యాక్టివ్ ఆఫర్‌లు, బ్యానర్‌లు & ప్రమోషన్‌లు',
    ...
    startFreeTrialBtnTemplate: '{days} రోజుల ఉచిత ట్రయల్ ప్రారంభించండి',
    freeTrialNoPaymentDesc: 'ఇప్పుడు చెల్లింపు అవసరం లేదు - షాప్ సెట్టింగ్‌ల నుండి ఎప్పుడైనా అప్‌గ్రేడ్ చేసుకోవచ్చు.',
    startingTrialEllipsis: 'మీ ట్రయల్ ప్రారంభించబడుతోంది...',
    orDividerLabel: 'లేదా',
  ...
  kn: {
    ...
    suspendShopBtn: 'ಅಮಾನತುಗೊಳಿಸಿ',
    accountStatusLabel: 'ಖಾತೆ ಸ್ಥಿತಿ',
    reactivateShopBtn: 'ಮರುಸಕ್ರಿಯಗೊಳಿಸಿ',
    confirmSuspendShopMsg: '"{name}" ಅನ್ನು ಅಮಾನತುಗೊಳಿಸುವುದೇ? ಅವರನ್ನು ತಕ್ಷಣ ಲಾಗಿನ್ ಆಗದಂತೆ ತಡೆಯಲಾಗುತ್ತದೆ.',
    ...
    contactMessagesTitle: 'ಸಂಪರ್ಕ ಸಂದೇಶಗಳು',
    contactMessagesSubtitle: 'ಸಾರ್ವಜನಿಕ ವೆಬ್‌ಸೈಟ್‌ನ ಸಂಪರ್ಕ ಫಾರ್ಮ್ ಮೂಲಕ ಕಳುಹಿಸಲಾದ ಸಂದೇಶಗಳು.',
    contactMessagesEmpty: 'ಇನ್ನೂ ಸಂದೇಶಗಳಿಲ್ಲ.',
    failedLoadContactMessagesMsg: 'ಸಂಪರ್ಕ ಸಂದೇಶಗಳನ್ನು ಲೋಡ್ ಮಾಡಲು ವಿಫಲವಾಗಿದೆ.',
    markAsReadBtn: 'ಓದಿದ್ದು ಎಂದು ಗುರುತಿಸಿ',
    newBadge: 'ಹೊಸದು',
    ...
    subscriptionValidUntilLabel: 'ಚಂದಾದಾರಿಕೆ ಮಾನ್ಯತಾ ದಿನಾಂಕ',
    ...
    activeOffersBannersDesc: 'ಸಕ್ರಿಯ ಆಫರ್‌ಗಳು, ಬ್ಯಾನರ್‌ಗಳು & ಪ್ರಚಾರಗಳು',
    ...
    startFreeTrialBtnTemplate: '{days} ದಿನಗಳ ಉಚಿತ ಪ್ರಯೋಗವನ್ನು ಪ್ರಾರಂಭಿಸಿ',
    freeTrialNoPaymentDesc: 'ಈಗ ಪಾವತಿ ಅಗತ್ಯವಿಲ್ಲ - ಶಾಪ್ ಸೆಟ್ಟಿಂಗ್‌ಗಳಿಂದ ಯಾವಾಗ ಬೇಕಾದರೂ ಅಪ್‌ಗ್ರೇಡ್ ಮಾಡಬಹುದು.',
    startingTrialEllipsis: 'ನಿಮ್ಮ ಪ್ರಯೋಗ ಪ್ರಾರಂಭವಾಗುತ್ತಿದೆ...',
    orDividerLabel: 'ಅಥವಾ',
  ...
  ml: {
    ...
    suspendShopBtn: 'താൽക്കാലികമായി നിർത്തുക',
    accountStatusLabel: 'അക്കൗണ്ട് സ്റ്റാറ്റസ്',
    reactivateShopBtn: 'വീണ്ടും സജീവമാക്കുക',
    confirmSuspendShopMsg: '"{name}" താൽക്കാലികമായി നിർത്തണോ? അവരെ ഉടനടി ലോഗിൻ ചെയ്യുന്നതിൽ നിന്ന് തടയും.',
    ...
    contactMessagesTitle: 'ബന്ധപ്പെടൽ സന്ദേശങ്ങൾ',
    contactMessagesSubtitle: 'പൊതു വെബ്സൈറ്റിന്റെ ബന്ധപ്പെടൽ ഫോം വഴി അയച്ച സന്ദേശങ്ങൾ.',
    contactMessagesEmpty: 'ഇതുവരെ സന്ദേശങ്ങളൊന്നുമില്ല.',
    failedLoadContactMessagesMsg: 'ബന്ധപ്പെടൽ സന്ദേശങ്ങൾ ലോഡ് ചെയ്യുന്നതിൽ പരാജയപ്പെട്ടു.',
    markAsReadBtn: 'വായിച്ചതായി അടയാളപ്പെടുത്തുക',
    newBadge: 'പുതിയത്',
    ...
    subscriptionValidUntilLabel: 'സബ്‌സ്ക്രിപ്ഷൻ കാലാവധി തീയതി',
    ...
    offersLabel: 'ഓഫറുകൾ',
    activeOffersBannersDesc: 'സജീവ ഓഫറുകൾ, ബാനറുകൾ & പ്രമോഷനുകൾ',
    ...
    startFreeTrialBtnTemplate: '{days} ദിവസത്തെ സൗജന്യ ട്രയൽ ആരംഭിക്കുക',
    freeTrialNoPaymentDesc: 'ഇപ്പോൾ പണമടയ്ക്കേണ്ടതില്ല - എപ്പോൾ വേണമെങ്കിലും ഷോപ്പ് സെറ്റിംഗ്സിൽ നിന്ന് അപ്ഗ്രേഡ് ചെയ്യാം.',
    startingTrialEllipsis: 'നിങ്ങളുടെ ട്രയൽ ആരംഭിക്കുന്നു...',
    orDividerLabel: 'അല്ലെങ്കിൽ',
